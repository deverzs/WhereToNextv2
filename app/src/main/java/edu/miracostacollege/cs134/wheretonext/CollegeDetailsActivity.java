...
public class CollegeDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String temp = String.format("In-state Tuition: " + currency.format(tuition)) ;
        Log.i("Tuition text" , "" + currency.format(tuition));
        ...
        collegeDetailsTuitionTextView.setText(temp);
